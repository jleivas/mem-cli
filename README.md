...
```bash
pipx install dist/mem_cli-0.1.2-py3-none-any.whl
```
...
If you want `mem serve` to start automatically when you log in, run the setup
...
This creates an OS-specific startup item and starts the MCP server now:
